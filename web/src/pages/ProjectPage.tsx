...
import { formatDate, parseDate, truncateString, bytesToMegabytes, getTimeDifference, singleProjectPageSteps } from "../helpers/utils";
...
const ProjectPage: React.FC = () => {
	...
	const { projects, setRunTutorial } = useContext(StateContext);
	const { projectData, isLoading, runTutorial } = useProjectPageContext();
